...
<body>
    <main>
     ...
     <!-- NUEVA SECCIÓN: Domina Wall Street desde Latinoamérica -->
  <section class="hero">
  ...
  <div>
    <img src="img/img-1.png" alt="Portada del ebook Cómo Invertir en Wall Street" class="hero-img">
  </div>
</section> 

 <!-- SECCION QUE VAS APRENDER CON ESTE EBOOK-->
  ...
  <div class="chapters-container">
    ...
    <div class="chapter-cta">
      <div class="chapter-img">
        <img src="img/img-2.PNG" alt="Portada Cómo invertir en Wall Street" loading="lazy">
      </div>
    ...
    <!-- SECCION PARA QUIEN ES ESTE EBBOK-->
...
<section class="testimonios">
  <div class="testimonios-container">
    ...
    <div class="testimonial">
      <img src="img/img-8.jpeg" alt="Foto de Carolin" class="foto-testimonio">
    ...
    <div class="testimonial">
      <img src="img/img-9.jpeg" alt="Foto de Juan" class="foto-testimonio">
    ...
    <div class="testimonial">
      <img src="img/img-10.jpeg" alt="Foto de Marco" class="foto-testimonio">
...
<section class="faq">
  <div class="faq-container">
    <div class="faq-img">
      <img src="img/img-7.png" alt="Preguntas frecuentes">
    </div>
    <div class="faq-content">
      ...
      <a href="https://2spq2i-f3.myshopify.com/checkouts/cn/Z2NwLXVzLWVhc3QxOjAxSlpYSlJYMjJFS1JIOVg5QzlQUFJKNjRF?preview_theme_id=180368081214" 
     
      target="_blank" 
      rel="noopener noreferrer"
      class="cta-green">ACCEDER AHORA A MI EBOOK</a>
    </div>
  </div>
</section>
